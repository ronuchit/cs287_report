...
To select between the potential refinement options, the authors learn two decision tree regressors
...
This implicitly assumes that dependencies in plans are, in some way, local;
