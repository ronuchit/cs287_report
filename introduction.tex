...
\begin{figure}[t]
  \centering
    \includegraphics[scale=0.2]{images/grasp_teaser_bad.png}
    \includegraphics[scale=0.2]{images/grasp_teaser_good.png}
  \caption{\small{When trying to grasp the black can, the grasping pose sampled by a robot can
significantly affect the quality of the obstructions determined. In the left image, 5 objects obstruct the
