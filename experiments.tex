...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.35\linewidth}
    \includegraphics[width=\textwidth]{images/black.jpg}
...
toward the closest table edge from $o$, as shown in figure TODO. The first feature, exists\_obstr, is a binary variable indicating
...
Table \ref{table:results} summarizes our quantitative results. TODO: describe figures with figref!!!
The results demonstrate significant improvements in performance to the baseline systems for success rate and
